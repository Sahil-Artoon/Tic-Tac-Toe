...
const checkWinner = (findTableForCheckWinner) => __awaiter(void 0, void 0, void 0, function* () {
    if (findTableForCheckWinner.currentTurnSeatIndex == 0) {
        ...
        if (findTableForCheckWinner.playingData[0].symbol != "" && findTableForCheckWinner.playingData[1].symbol != "" && findTableForCheckWinner.playingData[2].symbol != "" && //1
    ...
    if (findTableForCheckWinner.currentTurnSeatIndex == 1) {
